...
if test "$FZF_DISABLE_KEYBINDINGS" -ne 1
    if test "$FZF_LEGACY_KEYBINDINGS" -eq 1
        ...
        bind \ec '__fzf_cd --hidden "!{.pyenv,.local,.idea,.vscode,tmp,/Users/sduran/Library,.vim,.git,node_modules,vendor,OneDrive\ -\ Knex}/*"'
        bind \eC '__fzf_cd --hidden "!{.pyenv,.local,.idea,.vscode,tmp,/Users/sduran/Library,.vim,.git,node_modules,vendor,OneDrive\ -\ Knex}/*"'
        bind \cg '__fzf_open'
        ...
        if ! test "$fish_key_bindings" = fish_default_key_bindings
            ...
            bind -M insert \ec '__fzf_cd --hidden "!{.pyenv,.local,.idea,.vscode,tmp,/Users/sduran/Library,.vim,.git,node_modules,vendor,OneDrive\ -\ Knex}/*"'
            bind -M insert \eC '__fzf_cd --hidden "!{.pyenv,.local,.idea,.vscode,tmp,/Users/sduran/Library,.vim,.git,node_modules,vendor,OneDrive\ -\ Knex}/*"'
